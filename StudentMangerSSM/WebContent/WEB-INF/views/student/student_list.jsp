		...
		<form id="photoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	<table id="addTable1" cellpadding="8">
	    		<tr >
	    			<td>预览头像:</td>
	    			<td>																								
	    				<img id="photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="/StudentMangerSSM/photo/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生头像:</td>
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable2" cellpadding="8">
	    		<input id="add_photo" type="hidden" name="photo" value="/StudentMangerSSM/photo/student.jpg"  />
	    		<tr >
	    			<td>学生姓名:</td>
	    			<td>
    	...
    	<form id="editPhotoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	<table id="editTable1" cellpadding="8">
	    		<tr >
	    			<td>预览头像:</td>
	    			<td>
	    				<img id="edit-photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="/StudentMangerSSM/photo/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生头像:</td>
   		...
   		<form id="editForm" method="post">
	    	...
	    	<table id="editTable2" cellpadding="8">
	    		<input id="edit_photo" type="hidden" name="photo" value="/StudentMangerSSM/photo/student.jpg"  />
	    		<tr >
	    			<td>学生姓名:</td>
	    			<td>
